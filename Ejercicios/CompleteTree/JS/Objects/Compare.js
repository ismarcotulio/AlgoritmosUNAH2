function Compare(){
	...
	function CompareCompare(obj1, obj2){
		...
		for(i=0; i<lesser; i++){
			if(typeof obj1[i] != "undefined" && typeof obj2[i] != "undefined" && this.alphabet.indexOf(obj1[i])<this.alphabet.indexOf(obj2[i])){
				return -1;
			}else if(typeof obj1[i] != "undefined" && typeof obj2[i] != "undefined" && this.alphabet.indexOf(obj1[i])>this.alphabet.indexOf(obj2[i])){
				return 1;
			}
